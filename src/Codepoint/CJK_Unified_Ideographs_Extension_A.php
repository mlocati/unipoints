...
{
    #[Info(id: 13312, name: 'CJK Ideograph Extension A, First', category: Cat::Other_Letter)]
    case CJK_Ideograph_Extension_A__First = "\u{3400}";

    #[Info(id: 19903, name: 'CJK Ideograph Extension A, Last', category: Cat::Other_Letter)]
