...
{
    #[Info(id: 173824, name: 'CJK Ideograph Extension C, First', category: Cat::Other_Letter)]
    case CJK_Ideograph_Extension_C__First = "\u{2A700}";

    #[Info(id: 177977, name: 'CJK Ideograph Extension C, Last', category: Cat::Other_Letter)]
